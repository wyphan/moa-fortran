...
set type "view100"
set title "Total time - catenation (100 pieces)"
...
set p [::Plotchart::createLogXYPlot .c {1.0e4 1.0e10 10.0} {0.0 5000.0 1000.0}]
#$p xconfig -format %.4e
...
foreach dir   {.       horizon linux} \
    ...
    foreach file {view1b view2b view3b view4b view5b} \
